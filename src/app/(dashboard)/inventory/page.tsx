        ...
        <div className="space-y-5">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-sm text-slate-500 dark:text-slate-400 mt-0.5">{items.length} item{items.length !== 1 ? 's' : ''}</p>
                </div>
                            ...
                            {paginated.map(i => {
                                ...
                                return (
                                    <TableRow key={i.itemid}>
                                        ...
                                        <TableCell className="px-4 py-3 text-slate-500 dark:text-slate-400">{i.category || '—'}</TableCell>
                                        <TableCell className="px-4 py-3 font-semibold text-slate-900 dark:text-slate-100">
                                            {i.quantity} <span className="font-normal text-slate-400 dark:text-slate-500 text-xs">{i.unit}</span>
                                        </TableCell>
                                        <TableCell className="px-4 py-3 text-slate-500 dark:text-slate-400 font-mono text-xs">
                                            {i.unitprice > 0 ? `$${i.unitprice.toFixed(2)}` : '—'}
                                        </TableCell>
                                        <TableCell className="px-4 py-3 text-slate-500 dark:text-slate-400 text-xs">{i.reorderlevel || '—'}</TableCell>
                                        ...
                                        <TableCell className="px-4 py-3 text-slate-500 dark:text-slate-400 text-xs">{i.location || '—'}</TableCell>
                                        <TableCell>
